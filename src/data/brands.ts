...
export const brands: Brand[] = [
  ...
  { slug: "bauknecht", name: "Bauknecht", nameLower: "Bauknecht", logo: `${basePath}/images/brands/bauknecht-1.png` },
  { slug: "blomberg", name: "Blomberg", nameLower: "Blomberg", logo: `${basePath}/images/brands/blloomberg.png` },
  { slug: "daewoo", name: "Daewoo", nameLower: "Daewoo", logo: `${basePath}/images/brands/daewoo-1.png` },
  { slug: "dexp", name: "DEXP", nameLower: "DEXP", logo: `${basePath}/images/brands/dexp-logo-png_seeklogo-320710.png` },
  { slug: "gaggenau", name: "Gaggenau", nameLower: "Gaggenau", logo: `${basePath}/images/brands/gaggenau.png` },
  { slug: "gorenje", name: "Gorenje", nameLower: "Gorenje", logo: `${basePath}/images/brands/gorenje.png` },
  { slug: "ignis", name: "Ignis", nameLower: "Ignis", logo: `${basePath}/images/brands/ignis.png` },
  ...
  { slug: "kraft", name: "Kraft", nameLower: "Kraft", logo: `${basePath}/images/brands/kraft.png` },
  ...
  { slug: "upo", name: "UPO", nameLower: "UPO", logo: `${basePath}/images/brands/upo-1.png` },
  { slug: "vestel", name: "Vestel", nameLower: "Vestel", logo: `${basePath}/images/brands/vestel-1.png` },
  { slug: "vestfrost", name: "Vestfrost", nameLower: "Vestfrost", logo: `${basePath}/images/brands/vestfrost.png` },
  { slug: "vyatka", name: "Вятка", nameLower: "Вятка", logo: `${basePath}/images/brands/ВЯТКА.png` },
  { slug: "zanussi", name: "Zanussi", nameLower: "Zanussi", logo: `${basePath}/images/brands/zanussi.png` },
